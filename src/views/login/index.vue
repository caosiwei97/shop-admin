    ...
    >
      ...
      <el-form-item prop="imgcode">
        <div class="imgcode-wrap">
          ...
          <img class="imgcode" alt="验证码" :src="codeSrc" @click="loadCode" />
        </div>
      </el-form-item>
      <el-form-item>
...
<script lang="ts" setup>
  ...
  onBeforeUnmount(() => {
    revokeURL(codeSrc.value)
  })

  const loadCode = async () => {
    const codeBlob = await getCode()
    codeSrc.value = getCodeURL(codeBlob)
  }

  const getCodeURL = (blob: Blob) => {
